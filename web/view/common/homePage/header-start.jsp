<%-- 
    ...
    Created on : May 24, 2025, 12:34:30 AM
    Author     : khanh
--%>
                                    ...
                                    <li class="top-hover"><a href="#">Tài khoản <i class="ion-chevron-down"></i></a>
                                        <ul>
                                            ...
                                            <li><a href="<%= request.getContextPath() %>/register.jsp">Đăng ký</a></li>
                                                ...
                                                %>  
                                            <li>
                                                <a href="<%= request.getContextPath() %>/login?service=logout">Đăng xuất</a>
                                            </li>

                                            <%
                                                    }
                                            %>
                                            <li><a href="../user/my-account.jsp">Tài khoản</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-6">
                        <div class="logo">
                            <a href="home.jsp">
                                <img alt="" src="${pageContext.request.contextPath}/img/img_book/logo.png">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="../homepage/contact.jsp">Home</a></li>
                                        <li class="top-hover"><a href="home.jsp">Book Management</a>

                                        </li>
                                        <li><a href="../homepage/about-us.jsp">CheckOut</a></li>
                                        <li class="mega-menu-position top-hover"><a href="../homepage/shop.jsp">Order Management</a>

                                        </li>
                                        <li class="top-hover"><a href="blog-left-sidebar.jsp">Inventory</a>

                                        </li>
                                        <li class="top-hover"><a href="#">Reports</a>
