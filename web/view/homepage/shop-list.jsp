...
<!-- Mirrored from htmldemo.net/phuler/phuler/shop-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 May 2025 15:19:11 GMT -->
<head>
        <meta charset="utf-8">
                ...
                <div class="row flex-row-reverse">
                    <div class="col-lg-9">
                        <div class="banner-area pb-30">
                            <a href="product-details.html"><img alt="" src="${pageContext.request.contextPath}/img/banner/banner-49.jpg"></a>
                        </div>
                        ...
                        <div class="shop-sidebar-wrapper gray-bg-7 shop-sidebar-mrg">
                            <div class="shop-widget">
                                ...
                                <div class="shop-catigory">
                                    <ul id="faq">
                                        <li> <a data-toggle="collapse" data-parent="#faq" href="#shop-catigory-1">Birthday Bouquets <i class="ion-ios-arrow-down"></i></a>
                                            <ul id="shop-catigory-1" class="panel-collapse collapse show">
                                                ...
                                                <li><a href="#">Bellflower</a></li>
                                                <li><a href="#">Buttercup</a></li>
                                            </ul>
                                        </li>
                                        <li> <a data-toggle="collapse" data-parent="#faq" href="#shop-catigory-2">Bride's Bouquets<i class="ion-ios-arrow-down"></i></a>
                                        ...
                                        <li> <a data-toggle="collapse" data-parent="#faq" href="#shop-catigory-3">Funeral Flowers <i class="ion-ios-arrow-down"></i></a>
