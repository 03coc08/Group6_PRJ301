<%-- 
    Tài liệu: staff
    Ngày tạo: August 18, 2025
    Tác giả: Gemini
    Mô tả: Trang giao diện cho Staff theo phong cách Staff.
--%>
...
<head>
    ...
    <title>Bảng điều khiển Nhân viên - MystBloom</title>
