                                    ...
                                    <li class="top-hover"><a href="#">Tài khoản <i class="ion-chevron-down"></i></a>
                                        <ul>
                                            <li><a href="../user/wishlist.jsp">Đã thích  </a></li>
                                                ...
                                                %>
                                            <li>
                                                <a href="<%= request.getContextPath() %>/login?service=loginUser">Đăng nhập</a>
                                            </li>
                                            <li><a href="<%= request.getContextPath() %>/login?service=register&tab=register">Đăng ký</a></li>
                                            <%
                                                } else {
                                            %>  
                                            <li>
                                    ...
                                    <ul>
                                        ...
                                        <li class="top-hover"><a href="#">pages</a>
                                            <ul class="submenu">
                                                ...
                                                <li><a href="../homepage/my-account.jsp">my account</a></li>
