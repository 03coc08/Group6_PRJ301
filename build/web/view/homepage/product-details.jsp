...
<!-- Mirrored from htmldemo.net/phuler/phuler/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 May 2025 15:19:11 GMT -->
<head>
        <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="product-details-img">
                            <img class="zoompro" src="${pageContext.request.contextPath}/img/product-details/product-detalis-l1.jpg" data-zoom-image="assets/img/product-details/product-detalis-bl1.jpg" alt="zoom"/>
                            <div id="gallery" class="mt-20 product-dec-slider owl-carousel">
                                <a data-image="assets/img/product-details/product-detalis-l1.jpg" data-zoom-image="assets/img/product-details/product-detalis-bl1.jpg">
                                    <img src="${pageContext.request.contextPath}/img/product-details/product-detalis-s1.jpg" alt="">
                                </a>
                                <a data-image="assets/img/product-details/product-detalis-l2.jpg" data-zoom-image="assets/img/product-details/product-detalis-bl2.jpg">
                                    <img src="${pageContext.request.contextPath}/img/product-details/product-detalis-s2.jpg" alt="">
                                </a>
                                <a data-image="assets/img/product-details/product-detalis-l3.jpg" data-zoom-image="assets/img/product-details/product-detalis-bl3.jpg">
                                    <img src="${pageContext.request.contextPath}/img/product-details/product-detalis-s3.jpg" alt="">
                                </a>
                                <a data-image="assets/img/product-details/product-detalis-l4.jpg" data-zoom-image="assets/img/product-details/product-detalis-bl4.jpg">
                                    <img src="${pageContext.request.contextPath}/img/product-details/product-detalis-s4.jpg" alt="">
                                </a>
                                <a data-image="assets/img/product-details/product-detalis-l5.jpg" data-zoom-image="assets/img/product-details/product-detalis-bl5.jpg">
                                    <img src="${pageContext.request.contextPath}/img/product-details/product-detalis-s5.jpg" alt="">
                                </a>
                                <a data-image="assets/img/product-details/product-detalis-l2.jpg" data-zoom-image="assets/img/product-details/product-detalis-bl2.jpg">
                                    <img src="${pageContext.request.contextPath}/img/product-details/product-detalis-s2.jpg" alt="">
                                </a>
...
<!-- Mirrored from htmldemo.net/phuler/phuler/product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 May 2025 15:19:12 GMT -->
</html>
