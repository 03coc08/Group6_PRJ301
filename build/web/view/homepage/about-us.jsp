...
<!-- Mirrored from htmldemo.net/phuler/phuler/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 May 2025 15:19:03 GMT -->
<head>
        <meta charset="utf-8">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-7 d-flex align-items-center">
                        <div class="overview-content-2">
                            <h2>Welcome To <span>MystBloom</span> Store !</h2>
                            <h3>MystBloomShop: Dự án công nghệ từ Nhóm sinh viên FPT University</h3>
                            <p class="peragraph-blog">
MystBloom là dự án tâm huyết được thai nghén và phát triển bởi đội ngũ sinh viên SE1935 của Đại học FPT. Chúng tôi mong muốn xây dựng một nền tảng điện hoa trực tuyến tiên tiến, tối ưu hóa quy trình bán hàng, tiết kiệm thời gian cho khách hàng và giải quyết hiệu quả những thách thức của ngành điện hoa truyền thống, mang đến một trải nghiệm đặt hoa tiện lợi và khác biệt hoàn toàn.
</p>
                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="overview-img text-center">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/img/banner/about-us.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-wrapper mb-30">
                            <div class="product-img">
                                <a href="product-details.html">
                                    <img src="${pageContext.request.contextPath}/img/team/team-4.jpg" alt="">
                                </a>
                                <div class="team-action">
                                    <a class="action-plus facebook" href="#">
                                        <i class="ion-social-facebook"></i>
            ...
            <div class="container">
                <div class="brand-logo-active owl-carousel">
                    <div class="single-brand-logo">
                        <img alt="" src="${pageContext.request.contextPath}/img/brand-logo/logo-1.png">
                    </div>
                    <div class="single-brand-logo">
                        <img alt="" src="${pageContext.request.contextPath}/img/brand-logo/logo-2.png">
                    </div>
                    <div class="single-brand-logo">
                        <img alt="" src="${pageContext.request.contextPath}/img/brand-logo/logo-3.png">
                    </div>
                    <div class="single-brand-logo">
                        <img alt="" src="${pageContext.request.contextPath}/img/brand-logo/logo-4.png">
                    </div>
                    <div class="single-brand-logo">
                        <img alt="" src="${pageContext.request.contextPath}/img/brand-logo/logo-5.png">
                    </div>
                    <div class="single-brand-logo">
                        <img alt="" src="${pageContext.request.contextPath}/img/brand-logo/logo-2.png">
                    </div>
...
<!-- Mirrored from htmldemo.net/phuler/phuler/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 May 2025 15:19:04 GMT -->
</html>
